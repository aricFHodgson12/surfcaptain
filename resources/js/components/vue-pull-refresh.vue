...
<script>
    ...
    // labels of pull down
    const LABELS = ['Error Refreshing', 'Pull to Refresh', 'Ready to Refresh', 'Loading Page'];
        ...
        mounted() {
            this.$nextTick(() => {
                ...
                el.addEventListener('touchstart', e => {
                    //if (el.scrollTop === 0) {
                    //console.log(el.scrollTop,document.documentElement.scrollTop,bodyEl.scrollTop);
                ...
                el.addEventListener('touchmove', e => {
                    if (!this.canPull || !this.allowPull) {
                        return;
                    }

                    //console.log(e.touches.item(0).pageY,touchPosition.start);
...
<style lang="scss">
    ...
    .pull-down-content {
        ...
        &--icon {
            ...
            margin-top: 10px;
            margin-left: -20px;
            background: url(../../../public/images/icon/vue-refresh-down-arrow.png) no-repeat center center;
            background-size: 20px 20px;
            &.pull-down-refresh {
                background: url(../../../public/images/icon/vue-refresh-refresh-icon.png) no-repeat center center;
                background-size: 20px 20px;
                animation: rotate 2s infinite;
                animation-timing-function: linear;
            }
            &.pull-down-error {
                background: url(../../../public/images/icon/vue-refresh-error-icon.png) no-repeat center center;
                background-size: 20px 20px;
            }
        }
        &--label {
